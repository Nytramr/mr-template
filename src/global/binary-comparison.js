...
export function ne(...args) {
  return pipedNodeFactory((...values) => {
    if (values.length !== 2) {
      throw new MrTemplateError(BINARY_COMPARISON_NE_ARGUMENTS_ERROR);
    }
...
export function lt(...args) {
  return pipedNodeFactory((...values) => {
    if (values.length !== 2) {
      throw new MrTemplateError(BINARY_COMPARISON_LT_ARGUMENTS_ERROR);
    }
    return values[0] < values[1];
  }, ...args);
}
export function le(...args) {
  return pipedNodeFactory((...values) => {
    if (values.length !== 2) {
      throw new MrTemplateError(BINARY_COMPARISON_LE_ARGUMENTS_ERROR);
    }
    return values[0] <= values[1];
  }, ...args);
}
export function gt(...args) {
  return pipedNodeFactory((...values) => {
    if (values.length !== 2) {
      throw new MrTemplateError(BINARY_COMPARISON_GT_ARGUMENTS_ERROR);
    }
    return values[0] > values[1];
  }, ...args);
}
export function ge(...args) {
  return pipedNodeFactory((...values) => {
    if (values.length !== 2) {
      throw new MrTemplateError(BINARY_COMPARISON_GE_ARGUMENTS_ERROR);
    }
    return values[0] >= values[1];
  }, ...args);
}
