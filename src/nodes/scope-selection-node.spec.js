import { ScopeSelection } from './scope-selection-node';
...
describe('ScopeSelection', () => {
  describe('isEmpty', () => {
    ...
    `(
      ...
      ({ nextValue, elseValue, resultValue }) => {
        const nodeEntity = new ScopeSelection(selector, nextNode, elseNode);
    ...
    `(
      ...
      ({ nextValue, resultValue }) => {
        const nodeEntity = new ScopeSelection(selector, nextNode);
        nextNode.isEmpty.mockReturnValue(nextValue);
